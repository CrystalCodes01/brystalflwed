      ...
      <div className="row">
        <div className="col">
          ...
          <section className="container-fluid col-12 col-md-8 pl-md-3 col-lg-6 text-left">
            ...
            <a
              className="larger-1x"
              href="https://goo.gl/maps/Hvfbp1ERFG6NLtAeA"
            >
            ...
            <p className="top-1x">
              ...
              <p className="top-1x">
                The <b>deadline</b> to book at the guaranteed reduced rate is
                March 15th, 2020.
                <br />
                You have to provide a credit card number for your reservation
                but will not be charged until the date of your stay.
              </p>
            </p>
            <p className="pb-0 mb-0 larger-1x">
            ...
            <p>
              <b>
                *Please note the prices displayed here and on the website
                include all taxes and resort fees - you may see a note about
                resort fees on the website - this does not apply to you as it is
                built into our room block rates.
              </b>
            </p>
            <p>
              <em className="teal">
              ...
              <br />
              If you are traveling with family or mutual friends the Partial
              View Superior Suite King is a good option to combine your stay and
              book together to save money. The Superior Suite King is a two room
              suite with a separate living room and single size pullout sofa. It
              has a connecting privacy door to the bedroom with one king size
              bed, each has its own private seating balcony and television with
              two full bathrooms.
              <br />
